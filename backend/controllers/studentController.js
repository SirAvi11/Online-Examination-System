...
exports.getDashboard = async (req, res) => {
 try {
        ...
        // 1) Basic exam counts
        const totalExamsAttempted = await StudentAttempt.countDocuments({ studentId: studentId });
        const totalUpcomingExams = await ExamRegistration.countDocuments({ studentId: studentId, startTime: {$gte: now}});
